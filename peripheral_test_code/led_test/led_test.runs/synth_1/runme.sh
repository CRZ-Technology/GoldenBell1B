...
HD_PWD='D:/sources/2026/GoldenBell1B/led_test/led_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_test.tcl
