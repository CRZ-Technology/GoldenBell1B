...
HD_PWD='D:/sources/2026/GoldenBell1B/led_test/led_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_test.tcl -notrace
