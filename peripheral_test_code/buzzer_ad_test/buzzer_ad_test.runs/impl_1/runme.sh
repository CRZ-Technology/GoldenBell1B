...
HD_PWD='D:/sources/2026/GoldenBell1B/buzzer_ad_test/buzzer_ad_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log buzzer_ad_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source buzzer_ad_test.tcl -notrace
