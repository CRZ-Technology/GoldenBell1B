...
HD_PWD='D:/sources/2026/GoldenBell1B/buzzer_ad_test/buzzer_ad_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log buzzer_ad_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source buzzer_ad_test.tcl
