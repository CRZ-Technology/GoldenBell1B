...
HD_PWD='D:/sources/2026/GoldenBell1B/fnd/fnd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fnd_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fnd_test.tcl
