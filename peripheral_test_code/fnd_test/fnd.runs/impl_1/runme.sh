...
HD_PWD='D:/sources/2026/GoldenBell1B/fnd/fnd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fnd_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fnd_test.tcl -notrace
