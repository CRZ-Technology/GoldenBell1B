...
HD_PWD='D:/sources/2026/GoldenBell1B/buzzer_test/buzzer_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log buzzer_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source buzzer_test.tcl -notrace
