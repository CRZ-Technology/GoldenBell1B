...
HD_PWD='D:/sources/2026/GoldenBell1B/buzzer_test/buzzer_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log buzzer_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source buzzer_test.tcl
