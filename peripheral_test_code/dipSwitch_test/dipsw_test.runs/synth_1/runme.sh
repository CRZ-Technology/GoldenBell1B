...
HD_PWD='D:/sources/2026/GoldenBell1B/dipsw_test/dipsw_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dip_switch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dip_switch.tcl
