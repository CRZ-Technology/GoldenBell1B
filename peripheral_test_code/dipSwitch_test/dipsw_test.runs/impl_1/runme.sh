...
HD_PWD='D:/sources/2026/GoldenBell1B/dipsw_test/dipsw_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dip_switch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dip_switch.tcl -notrace
